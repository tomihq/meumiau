...
export default async function PostPage({params}) {
  ...
  return (
        <main className=" max-w-4xl mx-auto gap-4 px-6 py-10 md:py-20">
         <script
      ...
      />
        ...
        <article className="prose prose-gray min-h-screen border-0    backdrop-blur-md border-purple-500/30  p-0 md:p-8 py-20">
