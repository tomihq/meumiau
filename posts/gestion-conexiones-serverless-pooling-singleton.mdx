...
Aunque la variable global persista entre warm starts, esto no garantiza que los sockets TCP subyacentes sigan abiertos. La base de datos o la infraestructura de red pueden cerrar conexiones inactivas.

En la práctica, esto no suele ser un problema porque drivers modernos como Mongoose y el driver oficial de MongoDB detectan automáticamente conexiones inválidas y las recrean cuando es necesario.
